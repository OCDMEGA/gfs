...
* Wellen: 
. Breiten sich aus mit Ausbreitungschgeschwindigkeit c
. Besitzen Frequenz f und Wellenlänge λ 
. Zusammenhang c=λ*f
. Bei elektromagnetischer Strahlung beträgt c Lichtgeschwindigkeit
. Bei elektromagnetischer Strahlung gilt: h(Planksches Wirkungsquantum)und Frequenz f bestimmen die energie der Strahlung (E=h*f)
. Strahlung mit kurzer Wellenlänge hat eine hohe Frequenz und (z.B. Gammastrahlung) hat somit eine hohe Energie
. In diesem Fall (EM) ist die Frequenz somit antiproportional zur Wellenlänge
. Alles nachweisbar durch Messungen des Fotoeffekts (Lichtstrahlung regt Elektronen an und lässt sie aus dem Material austreten, je höher die Energie der Strahlung desto mehr Elektronen können austreten) 
...
=== Bilder
* link:https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcSKVoSzJAMdSy5d45jP5uRrFRdtfWPDVUzfojwg1GXTYO8E2pbJ2F3nUVjy93ldi_O2CLGrIWzsVnZ_HM0[]
* link:https://www.spiegel.de/geschichte/wilhelm-conrad-roentgen-das-leiden-der-strahlen-pioniere-a-1061130.html[]